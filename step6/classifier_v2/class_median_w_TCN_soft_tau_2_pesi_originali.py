...
c_id = 0
p_value_TCN = scipy.io.loadmat('score_TCN_pesi_originali/TCN.mat')
p_value_noTCN = scipy.io.loadmat('score_TCN_pesi_originali/noTCN.mat')
...
###########################
        ...
        scipy.io.savemat("class_median_w_TCN_soft_tau_pesi_originali_opn.mat", mdic)
    c_id += 1
