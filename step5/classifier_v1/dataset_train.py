...
class VideoDataset(Dataset):
    ...
    def init_frame_num(self):
        ...
        for v in self.video_ids:
            #files = listdir(join(_root_dir, self.manipulations, _compression, self.specres, v))#_root_dir, _mask_dir, v))##_root_dir, _mask_dir, 'original', v))
    ...
    def get_images_labels_masks_mod(self, video_id, frames):
        ...
        for frame in range(0, frames):
            ...
            #images.append(self.read_fn(join(_root_dir, self.manipulations, _compression, self.specres, video_id, frame_num)))
...
def read_frame_masks_fine(id_manu, id_specres):
    ...
    print(video_ids)
    manipulations = _manipulations[id_manu]
