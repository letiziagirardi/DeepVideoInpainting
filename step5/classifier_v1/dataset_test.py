...
class VideoDataset(Dataset):
    ...
    def get_images_labels_masks_mod(self, video_id, frames):
        ...
        for frame in range(0, frames):
            ...
            #images.append(self.read_fn(join(_root_dir, _pristine_dir, _specres, video_id, frame_num)))#'frame_resized', 'frame',  frame_num)))# 'resized_' + resolution, video_id, frame_num)))
            #labels.append(0)
